...
# ax.plot(1000*t,yE,alpha=0.95,linewidth=2,color=Colors('Maroon'),label='Envelope')
ax.plot(1000*t,yS,alpha=0.95,linewidth=0.35,label='Sum',zorder=-100)
# ax.plot(1000*t,yF,alpha=1,linewidth=2,color=Safe('Yellow'),label='Low-Pass(Sum)')
# ax.plot(1000*t,yFA,alpha=1,linewidth=2,color=Safe('Orange'),label='Low-Pass(|Sum|)')
